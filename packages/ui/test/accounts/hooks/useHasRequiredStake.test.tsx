...
describe('useHasRequiredStake', () => {
  ...
  it.skip('Member has not enough founds', () => {
    balances = {
      [alice.address]: {
        ...zeroBalance,
        total: new BN(10),
  ...
  it.skip('Not enough funds with transferable funds', () => {
    balances = {
  ...
  it.skip('Not enough funds with transferable to an account with locked founds', () => {
    balances = {
      [alice.address]: {
        ...zeroBalance,
        total: new BN(450),
