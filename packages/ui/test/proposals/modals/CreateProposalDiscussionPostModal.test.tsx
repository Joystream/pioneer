...
import {
  CreateProposalDiscussionPostModal,
  CreateProposalDiscussionPostModalCall,
} from '@/forum/modals/PostActionModal/CreateProposalDiscussionPostModal'
...
describe('UI: CreatePostModal', () => {
  const api = stubApi()
  const txPath = 'api.tx.proposalsDiscussion.addPost'
  let tx: any
  stubTransaction(api, txPath)
  const modalData: ModalCallData<CreateProposalDiscussionPostModalCall> = {
    threadId: '1',
    postText: 'I disagree',
    isEditable: false,
  }
