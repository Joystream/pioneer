...
import { UNIT_VALUE } from '@/common/model/formatters'
    ...
    describe('Specific parameters', () => {
      ...
      describe('Type - Create Working Group Lead Opening', () => {
        ...
        it('Step 4: Invalid to valid', async () => {
          ...
          expect(data).toEqual({
            rewardPerBlock: step4.rewardPerBlock * UNIT_VALUE.toNumber(),
            stakePolicy: {
              stakeAmount: step4.stake * UNIT_VALUE.toNumber(),
      ...
      describe('Type - Set Working Group Lead Reward', () => {
        ...
        it('Valid form', async () => {
          ...
          expect(parameters).toEqual([Number(forumLeadId?.split('-')[1]), amount * UNIT_VALUE.toNumber(), group])
        })
      })
