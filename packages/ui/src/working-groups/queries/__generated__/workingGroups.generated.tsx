...
export type WorkerFieldsFragment = { __typename: 'Worker', id: string, runtimeId: number, applicationId: string, isLead: boolean, rewardPerBlock: any, missingRewardAmount?: Types.Maybe<any>, stake: any, membership: (
  ...
  ), group: { __typename: 'WorkingGroup', id: string, name: string }, status: { __typename: 'WorkerStatusActive' } | { __typename: 'WorkerStatusLeaving' } | { __typename: 'WorkerStatusLeft' } | { __typename: 'WorkerStatusTerminated' } };

export type WorkerDetailedFieldsFragment = (
  { __typename: 'Worker', roleAccount: string, rewardAccount: string, stakeAccount: string, entry: { __typename: 'OpeningFilledEvent', inBlock: number, network: Types.Network, createdAt: any }, application: { __typename: 'WorkingGroupApplication', id: string, openingId: string, opening: { __typename: 'WorkingGroupOpening', stakeAmount: any } } }
...
export type WorkingGroupFieldsFragment = { __typename: 'WorkingGroup', id: string, name: string, budget: any, metadata?: Types.Maybe<(
  ...
  )>, workers: Array<{ __typename: 'Worker', stake: any }>, leader?: Types.Maybe<{ __typename: 'Worker', membershipId: string }> };

export type WorkingGroupDetailedFieldsFragment = (
  { __typename: 'WorkingGroup', leader?: Types.Maybe<{ __typename: 'Worker', id: string, runtimeId: number, stake: any, membershipId: string }> }
...
export type WorkingGroupApplicationFieldsFragment = { __typename: 'WorkingGroupApplication', id: string, stakingAccount: string, opening: { __typename: 'WorkingGroupOpening', id: string, type: Types.WorkingGroupOpeningType, rewardPerBlock: any, group: { __typename: 'WorkingGroup', name: string } }, applicant: (
    { __typename: 'Membership' }
    & MemberFieldsFragment
  ), status: { __typename: 'ApplicationStatusPending' } | { __typename: 'ApplicationStatusAccepted' } | { __typename: 'ApplicationStatusRejected' } | { __typename: 'ApplicationStatusWithdrawn' } | { __typename: 'ApplicationStatusCancelled' }, createdInEvent: { __typename: 'AppliedOnOpeningEvent', createdAt: any, inBlock: number, network: Types.Network } };
...
export type UpcomingWorkingGroupOpeningFieldsFragment = { __typename: 'UpcomingWorkingGroupOpening', id: string, groupId: string, expectedStart?: Types.Maybe<any>, stakeAmount?: Types.Maybe<any>, rewardPerBlock?: Types.Maybe<any>, group: { __typename: 'WorkingGroup', name: string, budget: any, leaderId?: Types.Maybe<string> }, createdInEvent: { __typename: 'StatusTextChangedEvent', createdAt: any, inBlock: number, network: Types.Network }, metadata: (
    { __typename: 'WorkingGroupOpeningMetadata' }
    & WorkingGroupOpeningMetadataFieldsFragment
  ) };
...
export type GetWorkerUnstakingDetailsQuery = { __typename: 'Query', workerByUniqueInput?: Types.Maybe<{ __typename: 'Worker', status: { __typename: 'WorkerStatusActive' } | { __typename: 'WorkerStatusLeaving', workerStartedLeavingEvent?: Types.Maybe<{ __typename: 'WorkerStartedLeavingEvent', createdAt: any }> } | { __typename: 'WorkerStatusLeft' } | { __typename: 'WorkerStatusTerminated' }, application: { __typename: 'WorkingGroupApplication', opening: { __typename: 'WorkingGroupOpening', unstakingPeriod: number } } }> };
