...
export type PastWorkerFieldsFragment = { __typename: 'Worker', id: string, createdAt: any, updatedAt?: Types.Maybe<any>, membership: (
    { __typename: 'Membership' }
    & MemberFieldsFragment
  ), status: { __typename: 'WorkerStatusActive' } | { __typename: 'WorkerStatusLeaving' } | { __typename: 'WorkerStatusLeft', workerExitedEvent?: Types.Maybe<{ __typename: 'WorkerExitedEvent', createdAt: any, inBlock: number, network: Types.Network }> } | { __typename: 'WorkerStatusTerminated', terminatedWorkerEvent?: Types.Maybe<{ __typename: 'TerminatedWorkerEvent', createdAt: any, inBlock: number, network: Types.Network }> }, entry: { __typename: 'OpeningFilledEvent', createdAt: any, inBlock: number, network: Types.Network } };
...
export type GetPastWorkersQuery = { __typename: 'Query', workers: Array<(
    { __typename: 'Worker' }
