...
export const WatchWorkingGroupButton = ({ groupName }: Props) => {
  ...
  useEffect(() => {
    if(showNotification){
      if (watching) {
        var newNoti = {
          title: 'You are now watching this working group',
          message: 'You will receive notifications about important updates related to this working group',
        }
      } else {
        var newNoti = {
          title: 'You are no longer watching this working group',
          message: 'You will no longer receive any notifications about changes related to this working group',
        }
      }
