...
export const IncreasedIcon = ({ className }: StyledIcon) => (
  <Icon size="20" viewBox="0 0 20 20" fill="none" color="currentColor" className={className}>
    ...
    <rect
      width="3.33333"
      height="10"
      transform="matrix(-1 0 0 1 18.3333 8.33337)"
      fill="currentColor"
    />
    <rect
      width="3.33333"
      height="7.5"
      transform="matrix(-1 0 0 1 13.3333 10.8334)"
      fill="currentColor"
    />
    <rect
      width="3.33333"
      height="5"
      transform="matrix(-1 0 0 1 8.33331 13.3334)"
      fill="currentColor"
    />
    <rect
      width="3.33333"
      height="2.5"
      transform="matrix(-1 0 0 1 3.33331 15.8334)"
      fill="currentColor"
    />
  </Icon>
)
