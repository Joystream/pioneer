...
export const StorageWorkerIcon = React.memo(({ className }: StyledIcon) => (
  ...
  >
    ...
    <path
      ...
      fill={Colors.Black[900]}
    />
    <path fill-rule="evenodd" clip-rule="evenodd" d="M6 17H11V19H6V17Z" fill={Colors.Blue[500]} />
    <path fill-rule="evenodd" clip-rule="evenodd" d="M6 5H11V7H6V5Z" fill={Colors.Blue[500]} />
    <path fill-rule="evenodd" clip-rule="evenodd" d="M15 17L18 17L18 19L15 19L15 17Z" fill={Colors.Blue[500]} />
    <path fill-rule="evenodd" clip-rule="evenodd" d="M15 5L18 5L18 7L15 7L15 5Z" fill={Colors.Blue[500]} />
  </Icon>
))
