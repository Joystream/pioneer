...
export type MemberFieldsFragment = { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, handle: string, isVerified: boolean, isFoundingMember: boolean, inviteCount: number, metadata: { __typename: 'MemberMetadata', name?: Types.Maybe<string>, about?: Types.Maybe<string> }, roles: Array<{ __typename: 'Worker', createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> };

export type MemberWithDetailsFieldsFragment = (
  { __typename: 'Membership', entry: { __typename: 'MembershipEntryPaid', membershipBoughtEvent?: Types.Maybe<{ __typename: 'MembershipBoughtEvent', createdAt: any, inBlock: number, network: Types.Network }> } | { __typename: 'MembershipEntryInvited', memberInvitedEvent?: Types.Maybe<{ __typename: 'MemberInvitedEvent', createdAt: any, inBlock: number, network: Types.Network }> } | { __typename: 'MembershipEntryGenesis', phantom?: Types.Maybe<number> }, invitees: Array<(
...
export type GetMembersQuery = { __typename: 'Query', memberships: Array<(
    { __typename: 'Membership' }
    & MemberFieldsFragment
  )> };
...
export type GetMemberQuery = { __typename: 'Query', membershipByUniqueInput?: Types.Maybe<(
    { __typename: 'Membership' }
    & MemberWithDetailsFieldsFragment
  )> };
...
export type SearchMembersQuery = { __typename: 'Query', memberships: Array<(
    { __typename: 'Membership' }
    & MemberFieldsFragment
  )> };
