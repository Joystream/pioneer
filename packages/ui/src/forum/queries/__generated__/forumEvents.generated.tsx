...
export type GetForumEventsQuery = { __typename: 'Query', postAddedEvents: Array<{ __typename: 'PostAddedEvent', id: string, createdAt: any, post: { __typename: 'ForumPost', id: string, thread: { __typename: 'ForumThread', id: string }, author: { __typename: 'Membership', id: string, handle: string } } }>, postTextUpdatedEvents: Array<{ __typename: 'PostTextUpdatedEvent', id: string, createdAt: any, post: { __typename: 'ForumPost', id: string, thread: { __typename: 'ForumThread', id: string }, author: { __typename: 'Membership', id: string, handle: string } } }>, postDeletedEvents: Array<{ __typename: 'PostDeletedEvent', id: string, createdAt: any, posts: Array<{ __typename: 'ForumPost', id: string, thread: { __typename: 'ForumThread', id: string, title: string } }>, actor: { __typename: 'Membership', id: string, handle: string } }>, threadCreatedEvents: Array<{ __typename: 'ThreadCreatedEvent', id: string, createdAt: any, thread: { __typename: 'ForumThread', id: string, title: string, author: { __typename: 'Membership', id: string, handle: string } } }>, categoryCreatedEvents: Array<{ __typename: 'CategoryCreatedEvent', id: string, createdAt: any, category: { __typename: 'ForumCategory', id: string, title: string, parent?: { __typename: 'ForumCategory', id: string, title: string } | null | undefined } }> };
