...
export type CategoryCreatedEventFieldsFragment = { __typename: 'CategoryCreatedEvent', id: string, createdAt: any, category: { __typename: 'ForumCategory', id: string, title: string, parent?: Types.Maybe<{ __typename: 'ForumCategory', id: string, title: string }> } };
