...
export type ForumThreadFieldsFragment = { __typename: 'ForumThread', id: string, isSticky: boolean, categoryId: string, title: string, authorId: string, createdInEvent: { __typename: 'ThreadCreatedEvent', createdAt: any, inBlock: number, network: Types.Network }, status: { __typename: 'ThreadStatusActive' } | { __typename: 'ThreadStatusLocked', threadDeletedEvent?: Types.Maybe<{ __typename: 'ThreadDeletedEvent', createdAt: any, inBlock: number, network: Types.Network }> } | { __typename: 'ThreadStatusModerated' } | { __typename: 'ThreadStatusRemoved' } };
...
export type ForumPostWithoutReplyFieldsFragment = { __typename: 'ForumPost', id: string, createdAt: any, updatedAt?: Types.Maybe<any>, text: string, authorId: string, author: (
  ...
  ), postaddedeventpost?: Types.Maybe<Array<{ __typename: 'PostAddedEvent', createdAt: any, inBlock: number, network: Types.Network }>> };
...
export type GetPaginatedForumThreadsQuery = { __typename: 'Query', forumThreadsConnection: { __typename: 'ForumThreadConnection', totalCount: number, edges: Array<{ __typename: 'ForumThreadEdge', node: (
        { __typename: 'ForumThread' }
        & ForumThreadFieldsFragment
      ) }> } };
 ...
 * });
 */
export function useGetPaginatedForumThreadsQuery(baseOptions: Apollo.QueryHookOptions<GetPaginatedForumThreadsQuery, GetPaginatedForumThreadsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPaginatedForumThreadsQuery, GetPaginatedForumThreadsQueryVariables>(GetPaginatedForumThreadsDocument, options);
      }
export function useGetPaginatedForumThreadsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPaginatedForumThreadsQuery, GetPaginatedForumThreadsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPaginatedForumThreadsQuery, GetPaginatedForumThreadsQueryVariables>(GetPaginatedForumThreadsDocument, options);
        }
...
export type GetPaginatedForumThreadsQueryResult = Apollo.QueryResult<GetPaginatedForumThreadsQuery, GetPaginatedForumThreadsQueryVariables>;
