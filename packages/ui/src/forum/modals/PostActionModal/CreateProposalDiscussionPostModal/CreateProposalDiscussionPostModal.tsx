...
import { CreatePostSignModal } from '../CreatePostModal/CreatePostSignModal'
import { postActionMachine } from '../postActionMachine'
import { PostActionSuccessModal } from '../PostActionSuccessModal'

import { CreateProposalDiscussionPostModalCall } from '.'

export const CreateProposalDiscussionPostModal = () => {
  const {
    modalData: { postText, threadId, isEditable },
    hideModal,
  } = useModal<CreateProposalDiscussionPostModalCall>()
  ...
  const transaction = useMemo(
    () =>
      api &&
      active &&
      api.tx.proposalsDiscussion.addPost(
