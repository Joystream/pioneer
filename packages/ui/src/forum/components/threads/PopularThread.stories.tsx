...
export default {
  title: 'Forum/Threads/PopularThread',
  component: PopularThread,
  argTypes: {
...
const categoryId = 'PopularThread-category-story'
    ...
    <MockApolloProvider members forum={forum}>
      <MemoryRouter>
        <Container size={containerSize}>
          <PopularThread thread={forumthread} empty={empty} />
        </Container>
      </MemoryRouter>
    </MockApolloProvider>
  )
