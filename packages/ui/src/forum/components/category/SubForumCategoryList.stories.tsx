...
import { SubForumCategoryList } from './SubForumCategoryList'

export default {
  title: 'Forum/Categories/SubForumCategoryList',
  component: SubForumCategoryList,
} as Meta
...
const Template: Story = ({ isArchive }) => {
  ...
  return (
    <MockApolloProvider members workers forum>
      ...
      />
      <MemoryRouter>
        {!categories.length ? <Loading /> : <SubForumCategoryList categories={categories} isArchive={isArchive} />}
      </MemoryRouter>
    </MockApolloProvider>
  )
}
