...
import { AccountRow, BalanceInfoInRow, InfoTitle, InfoValue, Modal, ModalBody, ModalGlass, ModalHeader, ModalWrap } from '@/common/components/Modal'
...
export const PreviewAndValidateModal = ({ setIsPreviewModalShown, previewModalData }: PreviewAndValidateModalProps) => {
  ...
  useEffect(() => {
    setPreviewAccounts(previewModalData.map((item) => {
