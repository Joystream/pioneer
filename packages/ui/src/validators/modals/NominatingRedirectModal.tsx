...
export const NominatingRedirectModal = () => {
  const [show, setShow] = useLocalStorage<boolean>('NominateRedirectModal')
  const closeModal = () => {
    setShow(false)
  }
  ...
  if (show)
    return (
      <Modal modalSize="m" onClose={closeModal}>
        <ModalHeader title={'Nominate validator'} onClick={closeModal} />
        <ModalBody>
          <TextBig>
