...
import { ValidatorOverviewTable, ValidatorOverViewClaimButton } from '../styles'
...
export const ValidatorAccounts = ({ vote, $colLayout }: PastVoteProps) => {
    ...
    return (
        <ValidatorOverviewTable $isPast $colLayout={$colLayout}>
            ...
            <TransactionButtonWrapper>
                <ValidatorOverViewClaimButton size="small" disabled={isDisabled} onClick={onClick}>
                    {isRecovered ? 'Stake recovered' : 'Recover stake'}
                </ValidatorOverViewClaimButton>
            </TransactionButtonWrapper>
        </ValidatorOverviewTable>
    )
}
