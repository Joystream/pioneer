...
export const GetSidebarInfoDocument = gql`
  ...
  candidacyNoteMetadata(
    where: {candidacynoteseteventnoteMetadata_every: {candidate: {status_eq: ACTIVE, member: {id_eq: $memberId}}}}
  ) {
    id
    header
  }
