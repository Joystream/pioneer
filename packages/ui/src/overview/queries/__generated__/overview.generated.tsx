...
import { UpcomingWorkingGroupOpeningFieldsFragmentDoc, WorkingGroupOpeningFieldsFragmentDoc } from '../../../working-groups/queries/__generated__/workingGroups.generated';
...
export const GetAllDeadLinesDocument = gql`
  ...
  workingGroupOpenings(
    where: {group: $group, status_json: {isTypeOf_eq: "OpeningStatusOpen"}}
  ) @include(if: $isLead) {
 ...
 * });
 */
export function useGetAllDeadLinesQuery(baseOptions: Apollo.QueryHookOptions<GetAllDeadLinesQuery, GetAllDeadLinesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllDeadLinesQuery, GetAllDeadLinesQueryVariables>(GetAllDeadLinesDocument, options);
      }
export function useGetAllDeadLinesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllDeadLinesQuery, GetAllDeadLinesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
