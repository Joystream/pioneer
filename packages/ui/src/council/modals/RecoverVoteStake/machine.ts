...
export type RecoverVoteStakeEvent = { type: 'FAIL' } | { type: 'PASS' }

export const recoverVoteStakeMachine = createMachine<TransactionContext, RecoverVoteStakeEvent, RecoverVoteStakeState>({
