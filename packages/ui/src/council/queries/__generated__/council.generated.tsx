...
export type ElectedCouncilFieldsFragment = { __typename: 'ElectedCouncil', id: string, electedAtBlock: number, electedAtTime: any, electedAtNetwork: Types.Network, councilElections: Array<{ __typename: 'ElectionRound', cycleId: number }>, councilMembers: Array<{ __typename: 'CouncilMember', id: string, unpaidReward: any, stake: any, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, councilMembers: Array<{ __typename: 'CouncilMember' }>, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> } }> };
...
export type PastCouncilDetailedFieldsFragment = { __typename: 'ElectedCouncil', id: string, endedAtBlock?: number | null, endedAtNetwork?: Types.Network | null, endedAtTime?: any | null, councilMembers: Array<{ __typename: 'CouncilMember', accumulatedReward: any, unpaidReward: any }> };

export type ElectionCandidateFieldsFragment = { __typename: 'Candidate', id: string, stake: any, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } };

export type ElectionRoundFieldsFragment = { __typename: 'ElectionRound', cycleId: number, candidates: Array<{ __typename: 'Candidate', id: string, stake: any, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } }> };

export type LatestElectionRoundFieldsFragment = { __typename: 'ElectionRound', isFinished: boolean, cycleId: number, candidates: Array<{ __typename: 'Candidate', id: string, stake: any, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } }> };

export type PastElectionRoundFieldsFragment = { __typename: 'ElectionRound', id: string, cycleId: number, endedAtBlock?: number | null, endedAtTime?: any | null, endedAtNetwork?: Types.Network | null, candidates: Array<{ __typename: 'Candidate', stake: any }>, castVotes: Array<{ __typename: 'CastVote', voteForId?: string | null }> };

export type PastElectionRoundDetailedFieldsFragment = { __typename: 'ElectionRound', id: string, cycleId: number, endedAtBlock?: number | null, endedAtTime?: any | null, endedAtNetwork?: Types.Network | null, candidates: Array<{ __typename: 'Candidate', stake: any, id: string, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } }>, castVotes: Array<{ __typename: 'CastVote', stake: any, stakeLocked: boolean, voteForId?: string | null, castBy: string }> };

export type ElectionCandidateDetailedFieldsFragment = { __typename: 'Candidate', stakingAccountId: string, rewardAccountId: string, id: string, stake: any, status: Types.CandidacyStatus, electionRound: { __typename: 'ElectionRound', cycleId: number, isFinished: boolean }, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } };

export type CastVoteFieldsFragment = { __typename: 'CastVote', id: string, stake: any, stakeLocked: boolean, castBy: string, commitment: string, voteFor?: { __typename: 'Candidate', id: string, stake: any, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } } | null, electionRound: { __typename: 'ElectionRound', cycleId: number }, castEvent?: Array<{ __typename: 'VoteCastEvent', inBlock: number, network: Types.Network, createdAt: any }> | null };

export type CouncilSpendingEventFieldsFragment = { __typename: 'BudgetSpendingEvent', amount: any, type?: Types.EventTypeOptions | null };

export type FundingRequestApprovedFragment = { __typename: 'ProposalExecutedEvent', proposal: { __typename: 'Proposal', details: { __typename: 'AmendConstitutionProposalDetails' } | { __typename: 'CancelWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'CreateBlogPostProposalDetails' } | { __typename: 'CreateWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'DecreaseWorkingGroupLeadStakeProposalDetails' } | { __typename: 'EditBlogPostProposalDetails' } | { __typename: 'FillWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'FundingRequestProposalDetails', destinationsList?: { __typename: 'FundingRequestDestinationsList', destinations: Array<{ __typename: 'FundingRequestDestination', amount: any, account: string }> } | null } | { __typename: 'LockBlogPostProposalDetails' } | { __typename: 'RuntimeUpgradeProposalDetails' } | { __typename: 'SetCouncilBudgetIncrementProposalDetails' } | { __typename: 'SetCouncilorRewardProposalDetails' } | { __typename: 'SetInitialInvitationBalanceProposalDetails' } | { __typename: 'SetInitialInvitationCountProposalDetails' } | { __typename: 'SetMaxValidatorCountProposalDetails' } | { __typename: 'SetMembershipLeadInvitationQuotaProposalDetails' } | { __typename: 'SetMembershipPriceProposalDetails' } | { __typename: 'SetReferralCutProposalDetails' } | { __typename: 'SetWorkingGroupLeadRewardProposalDetails' } | { __typename: 'SignalProposalDetails' } | { __typename: 'SlashWorkingGroupLeadProposalDetails' } | { __typename: 'TerminateWorkingGroupLeadProposalDetails' } | { __typename: 'UnlockBlogPostProposalDetails' } | { __typename: 'UpdateWorkingGroupBudgetProposalDetails' } | { __typename: 'VetoProposalDetails' } } };
...
export type GetPastCouncilsQuery = { __typename: 'Query', electedCouncils: Array<{ __typename: 'ElectedCouncil', id: string, endedAtBlock?: number | null, endedAtNetwork?: Types.Network | null, endedAtTime?: any | null }> };

export type GetPastCouncilsCountQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetPastCouncilsCountQuery = { __typename: 'Query', electedCouncilsConnection: { __typename: 'ElectedCouncilConnection', totalCount: number } };
...
export type GetPastCouncilQuery = { __typename: 'Query', electedCouncilByUniqueInput?: { __typename: 'ElectedCouncil', id: string, endedAtBlock?: number | null, endedAtNetwork?: Types.Network | null, endedAtTime?: any | null, councilMembers: Array<{ __typename: 'CouncilMember', accumulatedReward: any, unpaidReward: any }> } | null, budgetSpendingEvents: Array<{ __typename: 'BudgetSpendingEvent', amount: any, type?: Types.EventTypeOptions | null }>, fundingRequestsApproved: Array<{ __typename: 'ProposalExecutedEvent', proposal: { __typename: 'Proposal', details: { __typename: 'AmendConstitutionProposalDetails' } | { __typename: 'CancelWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'CreateBlogPostProposalDetails' } | { __typename: 'CreateWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'DecreaseWorkingGroupLeadStakeProposalDetails' } | { __typename: 'EditBlogPostProposalDetails' } | { __typename: 'FillWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'FundingRequestProposalDetails', destinationsList?: { __typename: 'FundingRequestDestinationsList', destinations: Array<{ __typename: 'FundingRequestDestination', amount: any, account: string }> } | null } | { __typename: 'LockBlogPostProposalDetails' } | { __typename: 'RuntimeUpgradeProposalDetails' } | { __typename: 'SetCouncilBudgetIncrementProposalDetails' } | { __typename: 'SetCouncilorRewardProposalDetails' } | { __typename: 'SetInitialInvitationBalanceProposalDetails' } | { __typename: 'SetInitialInvitationCountProposalDetails' } | { __typename: 'SetMaxValidatorCountProposalDetails' } | { __typename: 'SetMembershipLeadInvitationQuotaProposalDetails' } | { __typename: 'SetMembershipPriceProposalDetails' } | { __typename: 'SetReferralCutProposalDetails' } | { __typename: 'SetWorkingGroupLeadRewardProposalDetails' } | { __typename: 'SignalProposalDetails' } | { __typename: 'SlashWorkingGroupLeadProposalDetails' } | { __typename: 'TerminateWorkingGroupLeadProposalDetails' } | { __typename: 'UnlockBlogPostProposalDetails' } | { __typename: 'UpdateWorkingGroupBudgetProposalDetails' } | { __typename: 'VetoProposalDetails' } } }> };
...
export type GetPastCouncilMembersQuery = { __typename: 'Query', councilMembers: Array<{ __typename: 'CouncilMember', member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> } }>, proposalVotedEvents: Array<{ __typename: 'ProposalVotedEvent', voteKind: Types.ProposalVoteKind, voterId: string, proposal: { __typename: 'Proposal', id: string, title: string, statusSetAtTime: any, createdAt: any, councilApprovals: number, exactExecutionBlock?: number | null, status: { __typename: 'ProposalStatusCanceledByRuntime' } | { __typename: 'ProposalStatusCancelled' } | { __typename: 'ProposalStatusDeciding' } | { __typename: 'ProposalStatusDormant' } | { __typename: 'ProposalStatusExecuted' } | { __typename: 'ProposalStatusExecutionFailed' } | { __typename: 'ProposalStatusExpired' } | { __typename: 'ProposalStatusGracing' } | { __typename: 'ProposalStatusRejected' } | { __typename: 'ProposalStatusSlashed' } | { __typename: 'ProposalStatusVetoed' }, details: { __typename: 'AmendConstitutionProposalDetails' } | { __typename: 'CancelWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'CreateBlogPostProposalDetails' } | { __typename: 'CreateWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'DecreaseWorkingGroupLeadStakeProposalDetails' } | { __typename: 'EditBlogPostProposalDetails' } | { __typename: 'FillWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'FundingRequestProposalDetails' } | { __typename: 'LockBlogPostProposalDetails' } | { __typename: 'RuntimeUpgradeProposalDetails' } | { __typename: 'SetCouncilBudgetIncrementProposalDetails' } | { __typename: 'SetCouncilorRewardProposalDetails' } | { __typename: 'SetInitialInvitationBalanceProposalDetails' } | { __typename: 'SetInitialInvitationCountProposalDetails' } | { __typename: 'SetMaxValidatorCountProposalDetails' } | { __typename: 'SetMembershipLeadInvitationQuotaProposalDetails' } | { __typename: 'SetMembershipPriceProposalDetails' } | { __typename: 'SetReferralCutProposalDetails' } | { __typename: 'SetWorkingGroupLeadRewardProposalDetails' } | { __typename: 'SignalProposalDetails' } | { __typename: 'SlashWorkingGroupLeadProposalDetails' } | { __typename: 'TerminateWorkingGroupLeadProposalDetails' } | { __typename: 'UnlockBlogPostProposalDetails' } | { __typename: 'UpdateWorkingGroupBudgetProposalDetails' } | { __typename: 'VetoProposalDetails' }, creator: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> } } }> };
...
export type GetPastCouncilProposalsQuery = { __typename: 'Query', proposals: Array<{ __typename: 'Proposal', id: string, title: string, statusSetAtTime: any, createdAt: any, councilApprovals: number, exactExecutionBlock?: number | null, status: { __typename: 'ProposalStatusCanceledByRuntime' } | { __typename: 'ProposalStatusCancelled' } | { __typename: 'ProposalStatusDeciding' } | { __typename: 'ProposalStatusDormant' } | { __typename: 'ProposalStatusExecuted' } | { __typename: 'ProposalStatusExecutionFailed' } | { __typename: 'ProposalStatusExpired' } | { __typename: 'ProposalStatusGracing' } | { __typename: 'ProposalStatusRejected' } | { __typename: 'ProposalStatusSlashed' } | { __typename: 'ProposalStatusVetoed' }, details: { __typename: 'AmendConstitutionProposalDetails' } | { __typename: 'CancelWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'CreateBlogPostProposalDetails' } | { __typename: 'CreateWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'DecreaseWorkingGroupLeadStakeProposalDetails' } | { __typename: 'EditBlogPostProposalDetails' } | { __typename: 'FillWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'FundingRequestProposalDetails' } | { __typename: 'LockBlogPostProposalDetails' } | { __typename: 'RuntimeUpgradeProposalDetails' } | { __typename: 'SetCouncilBudgetIncrementProposalDetails' } | { __typename: 'SetCouncilorRewardProposalDetails' } | { __typename: 'SetInitialInvitationBalanceProposalDetails' } | { __typename: 'SetInitialInvitationCountProposalDetails' } | { __typename: 'SetMaxValidatorCountProposalDetails' } | { __typename: 'SetMembershipLeadInvitationQuotaProposalDetails' } | { __typename: 'SetMembershipPriceProposalDetails' } | { __typename: 'SetReferralCutProposalDetails' } | { __typename: 'SetWorkingGroupLeadRewardProposalDetails' } | { __typename: 'SignalProposalDetails' } | { __typename: 'SlashWorkingGroupLeadProposalDetails' } | { __typename: 'TerminateWorkingGroupLeadProposalDetails' } | { __typename: 'UnlockBlogPostProposalDetails' } | { __typename: 'UpdateWorkingGroupBudgetProposalDetails' } | { __typename: 'VetoProposalDetails' }, creator: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> } }> };
...
export type GetPastCouncilWorkingGroupsQuery = { __typename: 'Query', workingGroups: Array<{ __typename: 'WorkingGroup', id: string, name: string }>, budgetSetEvents: Array<{ __typename: 'BudgetSetEvent', newBudget: any, groupId: string }>, rewardPaidEvents: Array<{ __typename: 'RewardPaidEvent', groupId: string, amount: any }>, newMissedRewardLevelReachedEvents: Array<{ __typename: 'NewMissedRewardLevelReachedEvent', groupId: string, workerId: string, newMissedRewardAmount: any }> };

export type GetCurrentElectionQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetCurrentElectionQuery = { __typename: 'Query', electionRounds: Array<{ __typename: 'ElectionRound', cycleId: number, candidates: Array<{ __typename: 'Candidate', id: string, stake: any, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } }> }> };

export type GetLatestElectionQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetLatestElectionQuery = { __typename: 'Query', electionRounds: Array<{ __typename: 'ElectionRound', isFinished: boolean, cycleId: number, candidates: Array<{ __typename: 'Candidate', id: string, stake: any, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } }> }> };
...
export type GetPastElectionsQuery = { __typename: 'Query', electionRounds: Array<{ __typename: 'ElectionRound', id: string, cycleId: number, endedAtBlock?: number | null, endedAtTime?: any | null, endedAtNetwork?: Types.Network | null, candidates: Array<{ __typename: 'Candidate', stake: any }>, castVotes: Array<{ __typename: 'CastVote', voteForId?: string | null }> }> };

export type GetPastElectionsCountQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetPastElectionsCountQuery = { __typename: 'Query', electionRoundsConnection: { __typename: 'ElectionRoundConnection', totalCount: number } };
...
export type GetPastElectionQuery = { __typename: 'Query', electionRoundByUniqueInput?: { __typename: 'ElectionRound', id: string, cycleId: number, endedAtBlock?: number | null, endedAtTime?: any | null, endedAtNetwork?: Types.Network | null, candidates: Array<{ __typename: 'Candidate', stake: any, id: string, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } }>, castVotes: Array<{ __typename: 'CastVote', stake: any, stakeLocked: boolean, voteForId?: string | null, castBy: string }> } | null };
...
export type GetElectionCandidatesIdsQuery = { __typename: 'Query', candidates: Array<{ __typename: 'Candidate', id: string }> };
...
export type GetCurrentCandidateIdByMemberQuery = { __typename: 'Query', candidates: Array<{ __typename: 'Candidate', id: string }> };
...
export type GetCandidateStatsQuery = { __typename: 'Query', withdrawn: { __typename: 'CandidateConnection', totalCount: number }, successful: { __typename: 'CandidateConnection', totalCount: number }, failed: { __typename: 'CandidateConnection', totalCount: number } };
...
export type GetCouncilVotesQuery = { __typename: 'Query', castVotes: Array<{ __typename: 'CastVote', id: string, stake: any, stakeLocked: boolean, castBy: string, commitment: string, voteFor?: { __typename: 'Candidate', id: string, stake: any, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } } | null, electionRound: { __typename: 'ElectionRound', cycleId: number }, castEvent?: Array<{ __typename: 'VoteCastEvent', inBlock: number, network: Types.Network, createdAt: any }> | null }> };
...
export type GetCouncilVotesCommitmentsQuery = { __typename: 'Query', castVotes: Array<{ __typename: 'CastVote', commitment: string }> };
...
export type GetCouncilVotesCountQuery = { __typename: 'Query', castVotesConnection: { __typename: 'CastVoteConnection', totalCount: number } };
...
export type GetPastVotesResultsQuery = { __typename: 'Query', electionRounds: Array<{ __typename: 'ElectionRound', id: string, electedCouncil: { __typename: 'ElectedCouncil', councilMembers: Array<{ __typename: 'CouncilMember', member: { __typename: 'Membership', id: string } }> } }>, castVotes: Array<{ __typename: 'CastVote', voteFor?: { __typename: 'Candidate', id: string } | null, electionRound: { __typename: 'ElectionRound', id: string } }> };
...
export type GetCouncilBlockRangeQuery = { __typename: 'Query', electedCouncilByUniqueInput?: { __typename: 'ElectedCouncil', electedAtBlock: number, endedAtBlock?: number | null } | null };
...
export type GetPastCouncilStatsQuery = { __typename: 'Query', proposalsApproved: { __typename: 'ProposalExecutedEventConnection', totalCount: number }, fundingRequestsApproved: Array<{ __typename: 'ProposalExecutedEvent', proposal: { __typename: 'Proposal', details: { __typename: 'AmendConstitutionProposalDetails' } | { __typename: 'CancelWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'CreateBlogPostProposalDetails' } | { __typename: 'CreateWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'DecreaseWorkingGroupLeadStakeProposalDetails' } | { __typename: 'EditBlogPostProposalDetails' } | { __typename: 'FillWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'FundingRequestProposalDetails', destinationsList?: { __typename: 'FundingRequestDestinationsList', destinations: Array<{ __typename: 'FundingRequestDestination', amount: any, account: string }> } | null } | { __typename: 'LockBlogPostProposalDetails' } | { __typename: 'RuntimeUpgradeProposalDetails' } | { __typename: 'SetCouncilBudgetIncrementProposalDetails' } | { __typename: 'SetCouncilorRewardProposalDetails' } | { __typename: 'SetInitialInvitationBalanceProposalDetails' } | { __typename: 'SetInitialInvitationCountProposalDetails' } | { __typename: 'SetMaxValidatorCountProposalDetails' } | { __typename: 'SetMembershipLeadInvitationQuotaProposalDetails' } | { __typename: 'SetMembershipPriceProposalDetails' } | { __typename: 'SetReferralCutProposalDetails' } | { __typename: 'SetWorkingGroupLeadRewardProposalDetails' } | { __typename: 'SignalProposalDetails' } | { __typename: 'SlashWorkingGroupLeadProposalDetails' } | { __typename: 'TerminateWorkingGroupLeadProposalDetails' } | { __typename: 'UnlockBlogPostProposalDetails' } | { __typename: 'UpdateWorkingGroupBudgetProposalDetails' } | { __typename: 'VetoProposalDetails' } } }>, proposalsRejected: { __typename: 'ProposalDecisionMadeEventConnection', totalCount: number }, proposalsSlashed: { __typename: 'ProposalDecisionMadeEventConnection', totalCount: number }, budgetSpendingEvents: Array<{ __typename: 'BudgetSpendingEvent', amount: any, type?: Types.EventTypeOptions | null }> };
 ...
 * });
 */
export function useGetElectedCouncilQuery(baseOptions?: Apollo.QueryHookOptions<GetElectedCouncilQuery, GetElectedCouncilQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetElectedCouncilQuery, GetElectedCouncilQueryVariables>(GetElectedCouncilDocument, options);
      }
export function useGetElectedCouncilLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetElectedCouncilQuery, GetElectedCouncilQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetElectedCouncilQuery, GetElectedCouncilQueryVariables>(GetElectedCouncilDocument, options);
        }
 ...
 * });
 */
export function useGetPastCouncilsQuery(baseOptions?: Apollo.QueryHookOptions<GetPastCouncilsQuery, GetPastCouncilsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastCouncilsQuery, GetPastCouncilsQueryVariables>(GetPastCouncilsDocument, options);
      }
export function useGetPastCouncilsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastCouncilsQuery, GetPastCouncilsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useGetPastCouncilsCountQuery(baseOptions?: Apollo.QueryHookOptions<GetPastCouncilsCountQuery, GetPastCouncilsCountQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastCouncilsCountQuery, GetPastCouncilsCountQueryVariables>(GetPastCouncilsCountDocument, options);
      }
export function useGetPastCouncilsCountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastCouncilsCountQuery, GetPastCouncilsCountQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPastCouncilsCountQuery, GetPastCouncilsCountQueryVariables>(GetPastCouncilsCountDocument, options);
        }
...
export type GetPastCouncilsCountQueryResult = Apollo.QueryResult<GetPastCouncilsCountQuery, GetPastCouncilsCountQueryVariables>;
export const GetPastCouncilDocument = gql`
  ...
  fundingRequestsApproved: proposalExecutedEvents(
    where: {inBlock_gt: $fromBlock, inBlock_lt: $toBlock, proposal: {details_json: {isTypeOf_eq: "FundingRequestProposalDetails"}}}
  ) {
 ...
 * });
 */
export function useGetPastCouncilQuery(baseOptions: Apollo.QueryHookOptions<GetPastCouncilQuery, GetPastCouncilQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastCouncilQuery, GetPastCouncilQueryVariables>(GetPastCouncilDocument, options);
      }
export function useGetPastCouncilLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastCouncilQuery, GetPastCouncilQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
...
export const GetPastCouncilMembersDocument = gql`
  ...
  proposalVotedEvents(
    where: {inBlock_gte: $fromBlock, inBlock_lte: $toBlock}
    orderBy: [createdAt_DESC]
  ) {
 ...
 * });
 */
export function useGetPastCouncilMembersQuery(baseOptions: Apollo.QueryHookOptions<GetPastCouncilMembersQuery, GetPastCouncilMembersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastCouncilMembersQuery, GetPastCouncilMembersQueryVariables>(GetPastCouncilMembersDocument, options);
      }
export function useGetPastCouncilMembersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastCouncilMembersQuery, GetPastCouncilMembersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPastCouncilMembersQuery, GetPastCouncilMembersQueryVariables>(GetPastCouncilMembersDocument, options);
        }
...
export type GetPastCouncilMembersQueryResult = Apollo.QueryResult<GetPastCouncilMembersQuery, GetPastCouncilMembersQueryVariables>;
 ...
 * });
 */
export function useGetPastCouncilProposalsQuery(baseOptions: Apollo.QueryHookOptions<GetPastCouncilProposalsQuery, GetPastCouncilProposalsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastCouncilProposalsQuery, GetPastCouncilProposalsQueryVariables>(GetPastCouncilProposalsDocument, options);
      }
export function useGetPastCouncilProposalsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastCouncilProposalsQuery, GetPastCouncilProposalsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPastCouncilProposalsQuery, GetPastCouncilProposalsQueryVariables>(GetPastCouncilProposalsDocument, options);
        }
...
export type GetPastCouncilProposalsQueryResult = Apollo.QueryResult<GetPastCouncilProposalsQuery, GetPastCouncilProposalsQueryVariables>;
 ...
 * });
 */
export function useGetPastCouncilWorkingGroupsQuery(baseOptions: Apollo.QueryHookOptions<GetPastCouncilWorkingGroupsQuery, GetPastCouncilWorkingGroupsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastCouncilWorkingGroupsQuery, GetPastCouncilWorkingGroupsQueryVariables>(GetPastCouncilWorkingGroupsDocument, options);
      }
export function useGetPastCouncilWorkingGroupsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastCouncilWorkingGroupsQuery, GetPastCouncilWorkingGroupsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPastCouncilWorkingGroupsQuery, GetPastCouncilWorkingGroupsQueryVariables>(GetPastCouncilWorkingGroupsDocument, options);
        }
...
export type GetPastCouncilWorkingGroupsQueryResult = Apollo.QueryResult<GetPastCouncilWorkingGroupsQuery, GetPastCouncilWorkingGroupsQueryVariables>;
 ...
 * });
 */
export function useGetLatestElectionQuery(baseOptions?: Apollo.QueryHookOptions<GetLatestElectionQuery, GetLatestElectionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLatestElectionQuery, GetLatestElectionQueryVariables>(GetLatestElectionDocument, options);
      }
export function useGetLatestElectionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLatestElectionQuery, GetLatestElectionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLatestElectionQuery, GetLatestElectionQueryVariables>(GetLatestElectionDocument, options);
        }
 ...
 * });
 */
export function useGetPastElectionsQuery(baseOptions?: Apollo.QueryHookOptions<GetPastElectionsQuery, GetPastElectionsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastElectionsQuery, GetPastElectionsQueryVariables>(GetPastElectionsDocument, options);
      }
export function useGetPastElectionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastElectionsQuery, GetPastElectionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useGetPastElectionsCountQuery(baseOptions?: Apollo.QueryHookOptions<GetPastElectionsCountQuery, GetPastElectionsCountQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastElectionsCountQuery, GetPastElectionsCountQueryVariables>(GetPastElectionsCountDocument, options);
      }
export function useGetPastElectionsCountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastElectionsCountQuery, GetPastElectionsCountQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPastElectionsCountQuery, GetPastElectionsCountQueryVariables>(GetPastElectionsCountDocument, options);
        }
...
export type GetPastElectionsCountQueryResult = Apollo.QueryResult<GetPastElectionsCountQuery, GetPastElectionsCountQueryVariables>;
 ...
 * });
 */
export function useGetPastElectionQuery(baseOptions: Apollo.QueryHookOptions<GetPastElectionQuery, GetPastElectionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastElectionQuery, GetPastElectionQueryVariables>(GetPastElectionDocument, options);
      }
export function useGetPastElectionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastElectionQuery, GetPastElectionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useGetElectionCandidatesIdsQuery(baseOptions: Apollo.QueryHookOptions<GetElectionCandidatesIdsQuery, GetElectionCandidatesIdsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetElectionCandidatesIdsQuery, GetElectionCandidatesIdsQueryVariables>(GetElectionCandidatesIdsDocument, options);
      }
export function useGetElectionCandidatesIdsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetElectionCandidatesIdsQuery, GetElectionCandidatesIdsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetElectionCandidatesIdsQuery, GetElectionCandidatesIdsQueryVariables>(GetElectionCandidatesIdsDocument, options);
        }
...
export type GetElectionCandidatesIdsQueryResult = Apollo.QueryResult<GetElectionCandidatesIdsQuery, GetElectionCandidatesIdsQueryVariables>;
 ...
 * });
 */
export function useGetCurrentCandidateIdByMemberQuery(baseOptions: Apollo.QueryHookOptions<GetCurrentCandidateIdByMemberQuery, GetCurrentCandidateIdByMemberQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCurrentCandidateIdByMemberQuery, GetCurrentCandidateIdByMemberQueryVariables>(GetCurrentCandidateIdByMemberDocument, options);
      }
export function useGetCurrentCandidateIdByMemberLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCurrentCandidateIdByMemberQuery, GetCurrentCandidateIdByMemberQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCurrentCandidateIdByMemberQuery, GetCurrentCandidateIdByMemberQueryVariables>(GetCurrentCandidateIdByMemberDocument, options);
        }
export type GetCurrentCandidateIdByMemberQueryHookResult = ReturnType<typeof useGetCurrentCandidateIdByMemberQuery>;
export type GetCurrentCandidateIdByMemberLazyQueryHookResult = ReturnType<typeof useGetCurrentCandidateIdByMemberLazyQuery>;
export type GetCurrentCandidateIdByMemberQueryResult = Apollo.QueryResult<GetCurrentCandidateIdByMemberQuery, GetCurrentCandidateIdByMemberQueryVariables>;
export const GetCandidateStatsDocument = gql`
    query GetCandidateStats($memberId: ID) {
  withdrawn: candidatesConnection(
    where: {member: {id_eq: $memberId}, status_eq: WITHDRAWN}
  ) {
    totalCount
  }
  successful: candidatesConnection(
    where: {member: {id_eq: $memberId}, status_eq: ELECTED}
  ) {
    totalCount
  }
  failed: candidatesConnection(
    where: {member: {id_eq: $memberId}, status_eq: FAILED}
  ) {
    totalCount
  }
}
 ...
 * });
 */
export function useGetCandidateStatsQuery(baseOptions?: Apollo.QueryHookOptions<GetCandidateStatsQuery, GetCandidateStatsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCandidateStatsQuery, GetCandidateStatsQueryVariables>(GetCandidateStatsDocument, options);
      }
export function useGetCandidateStatsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCandidateStatsQuery, GetCandidateStatsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCandidateStatsQuery, GetCandidateStatsQueryVariables>(GetCandidateStatsDocument, options);
        }
 ...
 * });
 */
export function useGetCouncilVotesQuery(baseOptions?: Apollo.QueryHookOptions<GetCouncilVotesQuery, GetCouncilVotesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCouncilVotesQuery, GetCouncilVotesQueryVariables>(GetCouncilVotesDocument, options);
      }
export function useGetCouncilVotesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCouncilVotesQuery, GetCouncilVotesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useGetCouncilVotesCommitmentsQuery(baseOptions?: Apollo.QueryHookOptions<GetCouncilVotesCommitmentsQuery, GetCouncilVotesCommitmentsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCouncilVotesCommitmentsQuery, GetCouncilVotesCommitmentsQueryVariables>(GetCouncilVotesCommitmentsDocument, options);
      }
export function useGetCouncilVotesCommitmentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCouncilVotesCommitmentsQuery, GetCouncilVotesCommitmentsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCouncilVotesCommitmentsQuery, GetCouncilVotesCommitmentsQueryVariables>(GetCouncilVotesCommitmentsDocument, options);
        }
...
export type GetCouncilVotesCommitmentsQueryResult = Apollo.QueryResult<GetCouncilVotesCommitmentsQuery, GetCouncilVotesCommitmentsQueryVariables>;
 ...
 * });
 */
export function useGetCouncilVotesCountQuery(baseOptions?: Apollo.QueryHookOptions<GetCouncilVotesCountQuery, GetCouncilVotesCountQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCouncilVotesCountQuery, GetCouncilVotesCountQueryVariables>(GetCouncilVotesCountDocument, options);
      }
export function useGetCouncilVotesCountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCouncilVotesCountQuery, GetCouncilVotesCountQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCouncilVotesCountQuery, GetCouncilVotesCountQueryVariables>(GetCouncilVotesCountDocument, options);
        }
...
export type GetCouncilVotesCountQueryResult = Apollo.QueryResult<GetCouncilVotesCountQuery, GetCouncilVotesCountQueryVariables>;
export const GetPastVotesResultsDocument = gql`
    query GetPastVotesResults($myAccounts: [String!]) {
  electionRounds(
    where: {isFinished_eq: true, castVotes_some: {castBy_in: $myAccounts}}
  ) {
    id
    electedCouncil {
      councilMembers {
 ...
 * });
 */
export function useGetPastVotesResultsQuery(baseOptions?: Apollo.QueryHookOptions<GetPastVotesResultsQuery, GetPastVotesResultsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastVotesResultsQuery, GetPastVotesResultsQueryVariables>(GetPastVotesResultsDocument, options);
      }
export function useGetPastVotesResultsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastVotesResultsQuery, GetPastVotesResultsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPastVotesResultsQuery, GetPastVotesResultsQueryVariables>(GetPastVotesResultsDocument, options);
        }
...
export type GetPastVotesResultsQueryResult = Apollo.QueryResult<GetPastVotesResultsQuery, GetPastVotesResultsQueryVariables>;
 ...
 * });
 */
export function useGetCouncilBlockRangeQuery(baseOptions: Apollo.QueryHookOptions<GetCouncilBlockRangeQuery, GetCouncilBlockRangeQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCouncilBlockRangeQuery, GetCouncilBlockRangeQueryVariables>(GetCouncilBlockRangeDocument, options);
      }
export function useGetCouncilBlockRangeLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCouncilBlockRangeQuery, GetCouncilBlockRangeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCouncilBlockRangeQuery, GetCouncilBlockRangeQueryVariables>(GetCouncilBlockRangeDocument, options);
        }
...
export type GetCouncilBlockRangeQueryResult = Apollo.QueryResult<GetCouncilBlockRangeQuery, GetCouncilBlockRangeQueryVariables>;
export const GetPastCouncilStatsDocument = gql`
    query GetPastCouncilStats($startBlock: Int!, $endBlock: Int!) {
  proposalsApproved: proposalExecutedEventsConnection(
    where: {inBlock_gt: $startBlock, inBlock_lt: $endBlock}
  ) {
    totalCount
  }
  fundingRequestsApproved: proposalExecutedEvents(
    where: {inBlock_gt: $startBlock, inBlock_lt: $endBlock, proposal: {details_json: {isTypeOf_eq: "FundingRequestProposalDetails"}}}
  ) {
    ...FundingRequestApproved
  }
  proposalsRejected: proposalDecisionMadeEventsConnection(
    where: {inBlock_gt: $startBlock, inBlock_lt: $endBlock, decisionStatus_json: {isTypeOf_eq: "ProposalStatusRejected"}}
  ) {
    totalCount
  }
  proposalsSlashed: proposalDecisionMadeEventsConnection(
    where: {inBlock_gt: $startBlock, inBlock_lt: $endBlock, decisionStatus_json: {isTypeOf_eq: "ProposalStatusSlashed"}}
  ) {
    totalCount
  }
 ...
 * });
 */
export function useGetPastCouncilStatsQuery(baseOptions: Apollo.QueryHookOptions<GetPastCouncilStatsQuery, GetPastCouncilStatsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPastCouncilStatsQuery, GetPastCouncilStatsQueryVariables>(GetPastCouncilStatsDocument, options);
      }
export function useGetPastCouncilStatsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPastCouncilStatsQuery, GetPastCouncilStatsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPastCouncilStatsQuery, GetPastCouncilStatsQueryVariables>(GetPastCouncilStatsDocument, options);
        }
...
export type GetPastCouncilStatsQueryResult = Apollo.QueryResult<GetPastCouncilStatsQuery, GetPastCouncilStatsQueryVariables>;