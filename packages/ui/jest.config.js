...
module.exports = {
  ...
  // cacheDirectory: "/private/var/folders/cz/xdktbfw51yl1ybv4p6ffscxh0000gn/T/jest_dx",
  ...
  collectCoverageFrom: ['src/**/*.(ts|tsx)', '!src/**/*.stories.tsx', '!**/__generated__/*'],
  ...
  transformIgnorePatterns: ['\\\\/node_modules\\\\/(?!@ckeditor).+\\.(js|jsx|ts|tsx)$', '\\.pnp\\.[^\\/]+$'],
